<template>
  <div class="col-md-8 main-content">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="current-team">
          <flickity ref="flickity" v-if="data.currentTeam && data.currentTeam.length > 0">
            <div class="carousel-cell gallery-cell" v-for="(item, key) of data.currentTeam" :key="key" @click="showTeamModal(true, key)">
      ...
      <div class="col-md-6">
        ...
        <div class="current-team">
          <flickity ref="flickity" v-if="data.pastTeam && data.pastTeam.length > 0">
            <div class="carousel-cell gallery-cell" v-for="(item, key) of data.pastTeam" :key="key" @click="showTeamModal(false, key)">
              <img :src="item.imgPath" alt="Team 1">
              <h5>{{item.name}}</h5>
            </div>
          </flickity>
    ...
    <div class="row">
      <div class="col-md-12">
        <h5 class="heading">Badges</h5>
          <flickity class="badges" ref="flickity">
            ...
            <div class="carousel-cell gallery-cell is-initial-select">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="achivements">
          <flickity ref="flickity" v-if="data.acheivements && data.acheivements.length > 0">
            <div class="carousel-cell gallery-cell"  @click="showAchievementModal(index)" v-for="(item, index) of data.acheivements" :key="index">
    ...
    <b-modal ref="teamModal" id="modal1" title="Edit Team" hide-footer>
      <EditTeam :request="(Object.keys(this.data).length == 0) ? 'post' : 'put'" @submit="closeTeamModal" :type="teamToEdit.type"
